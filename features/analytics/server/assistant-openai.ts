...
function buildInputText(question: string, contextPayload: Record<string, unknown>, month: string) {
  return [
    "Du ar en strikt analytics-assistent for retaildata i en intern portal.",
    "Du far ENDAST anvanda datan i sektionen DATAUNDERLAG.",
    "Om svaret inte finns i underlaget, svara exakt: Jag hittar inte underlag for det i analytics-datat.",
    "Hall svaret kort, tydligt och pa svenska.",
    "Anvand punktlista vid jamforelser.",
    "Hitta inte pa externa fakta, antaganden eller allman kunskap.",
    "",
    "PERIOD:",
    month,
    "",
